...
const DEVIL_TEXTURE := preload("res://assets/generated/THE DEVIL.png")
...
func _choose_initial_appearance() -> void:
	var pmat: ParticleProcessMaterial = hit_particles.process_material
	if monster.slug == "satan":
		character.texture = DEVIL_TEXTURE
		...
		character.scale = Vector2(0.10, 0.10) # temporary
